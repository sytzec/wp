...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'organizedthemes' ),
		'top center'    => __( 'Top Center', 'organizedthemes' ),
		'top right'     => __( 'Top Right', 'organizedthemes' ),
		'center left'   => __( 'Middle Left', 'organizedthemes' ),
		'center center' => __( 'Middle Center', 'organizedthemes' ),
		'center right'  => __( 'Middle Right', 'organizedthemes' ),
		'bottom left'   => __( 'Bottom Left', 'organizedthemes' ),
		'bottom center' => __( 'Bottom Center', 'organizedthemes' ),
		'bottom right'  => __( 'Bottom Right', 'organizedthemes')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'organizedthemes' ),
		'fixed'  => __( 'Fixed in Place', 'organizedthemes')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'organizedthemes' ),
		'italic'      => __( 'Italic', 'organizedthemes' ),
		'bold'        => __( 'Bold', 'organizedthemes' ),
		'bold italic' => __( 'Bold Italic', 'organizedthemes' )
	);
